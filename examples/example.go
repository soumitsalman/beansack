...
func Nlp() {
	...
	// }
	inputs := datautils.Transform(getBeans("./examples/testdata/dataset2.json"), func(item *sdk.Bean) string { return nlp.TruncateTextOnTokenCount(item.Text) })
...
func getBeans(dataset string) []sdk.Bean {
